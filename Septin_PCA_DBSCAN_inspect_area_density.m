...
saveas(fig, fullfile(save_fold, 'PCA_DBSCAN_statistics_area_density.png'));
...
drawnow;
saveas(fig, fullfile(save_fold, 'PCA_DBSCAN_cells_structure_density_pca_variance_explained_area_density.png'));
...
ylabel('PC2');
drawnow;
saveas(fig, fullfile(save_fold, 'PCA_DBSCAN_refine_comined_cells_structure_density_pca_first_two_components_area_density.png'));
...
saveas(fig, fullfile(save_fold, 'PCA_DBSCAN_refine_comined_cells_structure_density_pca_first_two_components_area_density_centroids.png'));
...
saveas(fig, fullfile(save_fold, 'PCA_DBSCAN_refine_comined_cells_structure_density_pca_first_two_components_area_density_biplot.png'));
